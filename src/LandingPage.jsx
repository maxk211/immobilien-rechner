    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 text-lg">Immobilien<span className="text-blue-600">Portfolio</span></span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-sm font-semibold bg-blue-600 text-white px-4 py-2 rounded-xl hover:bg-blue-700 transition-all shadow-sm"
            >
              Kostenlos starten
            </button>
          </div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-32">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={onGetStarted}
                className="px-8 py-4 bg-blue-500 hover:bg-blue-400 text-white font-bold text-lg rounded-2xl transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-0.5"
              >
            ...
            <p className="text-sm text-slate-400 mt-4">
              ✓ 1 Immobilie dauerhaft kostenlos &nbsp;·&nbsp; ✓ Alle Features inklusive &nbsp;·&nbsp; ✓ Jederzeit kündbar
            </p>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-slate-500 text-lg mb-10">Die häufigsten Probleme von Immobilienbesitzern</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-white border border-red-100 rounded-2xl p-6 text-left shadow-sm">
                <div className="text-3xl mb-3">{item.icon}</div>
                <p className="text-slate-600 text-sm leading-relaxed">{item.text}</p>
              </div>
            ))}
          </div>
          <div className="mt-10 text-xl font-bold text-slate-800">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div key={i} className="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-md transition-all hover:-translate-y-0.5">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl border text-2xl mb-4 ${colorMap[f.color]}`}>
                  {f.icon}
                </div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-black mb-3">In 3 Minuten startklar</h2>
            <p className="text-blue-200 text-lg">Keine Einrichtung, kein Onboarding-Call, keine Kreditkarte</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="relative bg-white/10 border border-white/20 rounded-2xl p-6 text-center">
                <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center font-black text-lg mx-auto mb-4">
                  {item.step}
                </div>
                <div className="text-3xl mb-3">{item.icon}</div>
          ...
          <div className="text-center mt-10">
            <button
              onClick={onGetStarted}
              className="px-10 py-4 bg-white text-blue-700 font-bold text-lg rounded-2xl hover:bg-blue-50 transition-all shadow-lg"
            >
              Jetzt kostenlos starten →
            </button>
          </div>
      ...
      <section className="py-16 sm:py-24" id="pricing">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 text-lg">Kein verstecktes Kleingedrucktes. Kein Abo-Durcheinander.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-3xl p-8">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3 text-sm text-gray-400">
                  <span className="text-gray-300">✗</span> Mehr als 1 Immobilie
                </li>
              </ul>
              <button
                onClick={onGetStarted}
            ...
            {/* Pro */}
            <div className="relative bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-8 text-white shadow-xl shadow-blue-500/30">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-emerald-500 text-white text-xs font-bold px-4 py-1 rounded-full shadow">
                EMPFOHLEN
              </div>
              <div className="mb-6">
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl font-black text-slate-900 text-center mb-10">Häufige Fragen</h2>
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                <button
                  className="w-full text-left px-6 py-4 flex items-center justify-between gap-4 hover:bg-gray-50 transition-all"
                  onClick={() => setBillingOpen(billingOpen === i ? null : i)}
                >
                  <span className="font-semibold text-slate-800">{faq.q}</span>
                  <span className={`text-gray-400 text-xl transition-transform ${billingOpen === i ? 'rotate-45' : ''}`}>+</span>
                </button>
                {billingOpen === i && (
                  <div className="px-6 pb-5 text-slate-600 text-sm leading-relaxed border-t border-gray-100 pt-4">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* ── FINAL CTA ── */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-slate-900 to-blue-950 text-white text-center">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <button
            onClick={onGetStarted}
            className="px-10 py-4 bg-blue-500 hover:bg-blue-400 text-white font-bold text-xl rounded-2xl transition-all shadow-lg shadow-blue-500/30 hover:-translate-y-0.5"
          >
            Jetzt kostenlos starten →
          </button>
      ...
      <footer className="bg-slate-950 text-slate-500 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div>© {new Date().getFullYear()} ImmobilienPortfolio</div>
        </div>
      </footer>
