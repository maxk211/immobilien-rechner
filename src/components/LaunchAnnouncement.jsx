...
const LaunchAnnouncement = ({ onClose }) => (
  <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4">
    <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-br from-clay-600 via-clay-600 to-clay-700 px-6 pt-8 pb-10 text-center relative overflow-hidden">
      ...
      <div className="px-6 py-6">
        <p className="text-cream-600 text-sm leading-relaxed mb-5">
          Schön, dass du von Anfang an dabei bist! Als einer der ersten Nutzer bekommst du
          <strong className="text-cream-900"> vollen Zugriff auf alle Features</strong> — Portfolio-Tracking,
        ...
        <div className="bg-sage-50 border border-sage-200 rounded-2xl p-4 mb-6 flex items-start gap-3">
          ...
          <div>
            <div className="font-bold text-sage-900 text-sm">90 Tage komplett kostenlos</div>
            <p className="text-sage-700 text-xs mt-0.5 leading-relaxed">
        ...
        <button
          onClick={onClose}
          className="w-full py-3 bg-clay-600 text-white font-bold rounded-xl hover:bg-clay-700 transition-colors shadow-sm"
        >
          Los geht's! →
        </button>
      </div>
