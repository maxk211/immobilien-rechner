          ...
          {!initialData && (
            <div className="grid grid-cols-2 gap-2 mt-1">
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center mb-2 ${formModus === 'schnell' ? 'bg-indigo-500 text-white' : 'bg-gray-100 text-gray-500'}`}>
                  <Zap size={16}/>
                </div>
                <span className={`text-sm font-bold leading-tight ${formModus === 'schnell' ? 'text-indigo-700' : 'text-gray-700'}`}>Schnellstart</span>
                <span className="text-xs text-gray-400 mt-0.5 leading-tight">Nur das Wichtigste · ca. 2 Min.</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center mb-2 ${formModus === 'experte' ? 'bg-indigo-500 text-white' : 'bg-gray-100 text-gray-500'}`}>
                  <Settings size={16}/>
                </div>
                <span className={`text-sm font-bold leading-tight ${formModus === 'experte' ? 'text-indigo-700' : 'text-gray-700'}`}>Alle Details</span>
                <span className="text-xs text-gray-400 mt-0.5 leading-tight">Vollständige Eingabe</span>
              </button>
            </div>
          )}
        </div>
